      ...
      <div className="flex items-center space-x-3">
        ...
        <div>
          <h1 className="text-xl font-bold tracking-tight text-foreground flex items-center">
            <Edit3 className="h-5 w-5 text-primary mr-1.5" />
            Edit Content
          </h1>
          <p className="text-xs text-muted">Revise title fields, edit Markdown bodies, or adjust access configurations.</p>
        </div>
      </div>

      {error && (
        <div className="p-3 bg-red-500/10 border border-red-500/20 text-red-500 rounded-xl flex items-center space-x-2 text-xs max-w-xl">
